...
export const en: TranslationMap = {
  ...
  'hub.gameInProgress': 'Game in progress',
  'hub.returnToGame': 'Return to game',
  'hub.forceFinish': 'End game',
  'hub.confirmForceFinish': 'Are you sure you want to end the current game?',
